...
import demoBg from "../../public/images/demo-banner.png"
...
const Hero = () => {
  return (
    <section className="bg-hero flex flex-col md:flex-row justify-center items-center h-screen px-6 md:px-16 relative">
      ...
      {/* Text Section */}
      <div className="flex flex-col justify-center items-center text-center md:text-left md:w-1/2 mt-6 md:mt-0 relative">
        <motion.h1 
        ...
        <motion.h2 
          className="text-4xl md:text-6xl font-decaydence font-bold text-center w-full"
